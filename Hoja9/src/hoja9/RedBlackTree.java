 ...
 * @fuente Tomad del algoritmo creado por Arsenalist en Github:
 * https://github.com/Arsenalist/Red-Black-Tree-Java-Implementation/blob/master/src/RedBlackNode.java  
 * @parametro <T>
 * @proposito Implementar una Red BLack Tree
 */

public class RedBlackTree<T extends Comparable<T>> {

	// La Raiz se inicializa en nill
	...
	// @parametro: x, El nodo en el que se hara una rotacion izquierda.
	// Hace una rotacion hacia la izquierda en el nodo x
